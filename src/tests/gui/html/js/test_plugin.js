...
describe('Plugin', () => {
  describe('#Plugin()', () => {
    ...
    it('should set group to default if no key was passed', () => {
      const plugin = new Plugin({ name: 'test' });

      expect(plugin.group).toBe('default');
    });

    it("should set group to passed key's value", () => {
      const plugin = new Plugin({
        name: 'test',
        group: 'group1'
      });
  ...
  describe('#group', () => {
    ...
    it('getting value should return default if it has not been set in the constructor', () => {
      const plugin = new Plugin({ name: 'test' });
